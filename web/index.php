...
$router->addRoute(new Route("uncheckedUsers", "/uncheckedusers/:page", ["page" => "[\d]*"], UserController::class, "showUncheckedUsers"));
$router->addRoute(new Route("addAdmin", "/addadmin", [], UserController::class, "addAdmin"));
$router->addRoute(new Route("addUser", "/adduser", [], UserController::class, "addUser"));
$router->addRoute(new Route("deleteUser", "/deleteuser/:id", ["id" => "[\w]+"], UserController::class, "deleteUser"));
